...
setTimeout(() => {
    ...
    document.body.addEventListener('click', (event) => {
        if (event.target.matches('.container .adding-book')) {
            let addingBook = document.querySelector(".container .adding-book");
            let addForm = document.createElement('div');
            addForm.classList.add('add-form-div');
            let divContent = `
            <div class="exit">
                <button>X</button>
            </div>
            <form>
                ...
                <div class="box">
                    ...
                    <input type="text" id="title" name="title" id="title" required >
                </div>
                <div class="box">
                ...
                <div class="box">
                    ...
                    <input type="text" id="author" name="author" id="author" required>
                </div>
                <div class="box">
                    <label for="url">url</label>
                    <input type="text" id="url" name="url" id="url" required>
                </div>
                <input type="submit" class="submit" value="add">
            </form>`;
            addForm.innerHTML = divContent;
            document.body.appendChild(addForm);
            addingBook.style.display = "none";
        }
        if (event.target.matches('.add-form-div .exit button')) {
            let addingBook = document.querySelector(".container .adding-book");
            let addForm = event.target.closest('.add-form-div');
